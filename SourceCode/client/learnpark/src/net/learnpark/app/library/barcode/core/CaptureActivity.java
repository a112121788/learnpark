package net.learnpark.app.library.barcode.core;

import java.io.IOException;
import java.util.Collection;
import java.util.Hashtable;

import net.learnpark.app.learnpark.CourseReceiverActivity;
import net.learnpark.app.learnpark.R;
import net.learnpark.app.library.barcode.camera.CameraManager;
import net.learnpark.app.library.barcode.executor.ResultHandler;
